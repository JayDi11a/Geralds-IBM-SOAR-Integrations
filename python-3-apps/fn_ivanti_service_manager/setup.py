...
setup(
    ...
    entry_points={
        "resilient.circuits.components": [
            ...
            "{}FunctionComponent = fn_ivanti_service_manager.components.{}:FunctionComponent".format(snake_to_camel(get_module_name(filename)), get_module_name(filename)) for filename in glob.glob("./fn_ivanti_service_manager/components/[a-zA-Z]*.py")
        ],
