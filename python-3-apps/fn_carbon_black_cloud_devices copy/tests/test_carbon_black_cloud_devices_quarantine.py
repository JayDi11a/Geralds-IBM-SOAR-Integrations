...
class TestCarbonBlackCloudDevicesQuarantine:
    ...
    @pytest.mark.parametrize("incident_id, carbon_black_device_query_string, expected_results", [
        (123, "text", {"value": "xyz"}),
        (123, "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, incident_id, carbon_black_device_query_string, expected_results):
