...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'sumo_logic_search_by_job_id"""
    ...
    @function("sumo_logic_search_by_job_id")
    def _sumo_logic_search_by_job_id_function(self, event, *args, **kwargs):
        """Function: Searches Sumo Logic for search job results for a given search ID."""
        ...
        try:
            ...
            sumo_logic_search_id = kwargs.get("sumo_logic_search_id")  # text

            log = logging.getLogger(__name__)
            log.info("sumo_logic_search_id: %s", sumo_logic_search_id)
            ...
            while True:
                ...
                search_job_status_response = requests.get(
                    'https://{}/api/v1/search/jobs/{}'.format(host, sumo_logic_search_id),
            ...
            if search_results_found is True:
                ...
                search_job_result_response = requests.get(
                    'https://{}/api/v1/search/jobs/{}/messages'.format(host, sumo_logic_search_id), headers=headers,
                ...
                # TODO: pull out list object from 'messages' key and return it
