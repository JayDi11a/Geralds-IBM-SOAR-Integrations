...
setup(
    ...
    entry_points={
        "resilient.circuits.components": [
            ...
            "{}FunctionComponent = fn_palo_alto_wildfire.components.{}:FunctionComponent".format(snake_to_camel(get_module_name(filename)), get_module_name(filename)) for filename in glob.glob("./fn_palo_alto_wildfire/components/[a-zA-Z]*.py")
        ],
