...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'palo_alto_wildfire_file_submission_attachment"""
    ...
    @function("palo_alto_wildfire_file_submission_attachment")
    def _palo_alto_wildfire_file_submission_attachment_function(self, event, *args, **kwargs):
        """Function: This function pulls down the file from attachment in the Resilient Incident and submits the file to Palo Alto WildFire. The results of the file submission are returned to the Incident."""
        ...
        try:
            ...
            attachment_file_name = get_file_attachment_name(res_client=res_client, incident_id=incident_id,
                                                            artifact_id=None, task_id=None, attachment_id=attachment_id)
            log.info(attachment_file_name)
            ...
            try:
                ...
                submission_results = wildfire.submit_file(temp, attachment_file_name)
            ...
            #submission_sha256 = submission_results.values()[3] - python 2 method
            submission_sha256 = list(submission_results.values())[3]
